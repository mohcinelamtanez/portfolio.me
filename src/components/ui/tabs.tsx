...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn("inline-flex flex-wrap items-center gap-1 border-b border-border", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "relative px-3 py-2.5 font-mono text-2xs uppercase tracking-wide text-muted transition-colors",
